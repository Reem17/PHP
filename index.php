          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="courses.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Faculties</a>
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <?php          
                        include_once "faculty.php";
                        $f= new faculty();
                        $resultfac= $f->selectall();              
                        while($fetcherfac1=mysqli_fetch_assoc($resultfac))
                        {    
                          echo("<a class='dropdown-item' href='facultydetails.php'>".$fetcherfac1["fname"]." </a>");
                        }
                  ?>         
                </div>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sections</a>
                <div class="dropdown-menu" aria-labelledby="dropdown05">
                  <?php
                        ...
                        {    
                         echo("<a class='dropdown-item' href='sectiondetails.php'>".$fetchersec["secname"]." </a>");
                        }
                  ?>                       
                </div>
              ...
              <li class="nav-item">
                <a class="nav-link" href="blog.html">Staff</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="blog.html">Students</a>
              </li>
              <li class="nav-item">
            ...
            <ul class="navbar-nav absolute-right">
              <li>
                <a href="login as.php">Login</a> / <a href="register as.php">Register</a>
              </li>
            </ul>
        ...
        <div class="row align-items-center justify-content-center site-hero-inner">
          <div class="col-md-10">
            ...
            <div class="mb-5 element-animate">
              <div class="block-17">
                <h2 class="heading text-center mb-4">Register Your Graduation Project Now</h2>
                  ...
                  <div class="fields d-block d-lg-flex">
                    ...
                    <div class="select-wrap one-third">
                      ...
                      <select name="" id="" class="form-control">
                        <option value="Choose Your Faculty">Choose Your Faculty</option>
                        <?php   
                              include_once "faculty.php";
                              $f= new faculty();
                              $resultfac= $f->selectall();                     
                          while($fetcherfac2=mysqli_fetch_assoc($resultfac))
                          {    
                            echo("<option value='".$fetcherfac2["fno"]."'> ".$fetcherfac2["fname"]." </option>");
                          }
                        ?> 
                      </select>
                    </div>
                    <div class="select-wrap one-third">
                      <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                      <select name="" id="" class="form-control">
                        <option value="Choose Your Section">Choose Your Section</option>
                        <?php    
                             include_once "section.php";
                             $sec= new section();
                             $resultsec= $sec->selectall();         
                ...
                <p class="text-center"><a href="registerstudent.php" class="btn py-3 px-5">Register Now</a></p>
              </div>
            </div>
