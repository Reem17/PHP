              ...
              <?php	 
                if(isset($_POST['btnactcode']))
                {
                		...
                		if($row=mysqli_fetch_assoc($log))
                		{
                             ...
                             $link="http://localhost/university/updatepw.php?em=".$_POST['txtemail'];
                             ...
                             $mail = new  PHPMailer\PHPMailer\PHPMailer();
                                ...
                                $mail->Subject = 'Forget Professor Password (University)';
                                $mail->Body = "Dear Professor, Your Activation Code is".$activationcode ."please  visit this link ".$link;
